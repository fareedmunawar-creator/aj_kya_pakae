...
@section('content')
    ...
    <div class="auth-card">
        ...
        <div class="auth-header">
            <h4 class="mb-0 float">{{ __('Join Our Community') }}</h4>
        </div>
        <div class="auth-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4 animated-element delay-1">
                    <x-input-label for="name" :value="__('Name')" class="mb-2 fw-bold" />
                ...
                <!-- Confirm Password -->
                <div class="mb-4 animated-element delay-4">
                    <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="mb-2 fw-bold" />
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 animated-element delay-5">
